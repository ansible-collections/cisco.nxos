...
.. note::
   ...
   - The :ref:`nxos_overlay_global <nxos_overlay_global_module>` ``anycast_gateway_mac`` attribute must be set before setting the ``fabric_forwarding_anycast_gateway`` property.
