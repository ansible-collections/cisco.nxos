...
* Join the Ansible forum:
  ...
  * [Refer to your forum group here if exists](https://forum.ansible.com/g/network-wg): by joining the team you will automatically get subscribed to the posts tagged with [your group forum tag here](https://forum.ansible.com/tags/network).
