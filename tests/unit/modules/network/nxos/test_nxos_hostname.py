...
class TestNxosHostnameModule(TestNxosModule):
    ...
    def test_nxos_hostname_merged(self):
        ...
        set_module_args(
            {"config": {"hostname": "NXOSv-9k"}, "state": "merged"},
            ignore_provider_arg,
        )
    ...
    def test_nxos_hostname_linear_merged_2(self):
        ...
        set_module_args(
            {"config": {"hostname": "NXOSv"}, "state": "merged"},
            ignore_provider_arg,
        )
    ...
    def test_nxos_hostname_linear_replaced(self):
        ...
        set_module_args(
            {"config": {"hostname": "NXOSv"}, "state": "replaced"},
            ignore_provider_arg,
        )
        commands = ["hostname NXOSv"]
        result = self.execute_module(changed=True)
    ...
    def test_nxos_hostname_linear_overridden(self):
        ...
        set_module_args(
            {"config": {"hostname": "NXOSv"}, "state": "overridden"},
            ignore_provider_arg,
        )
        commands = ["hostname NXOSv"]
        result = self.execute_module(changed=True)
    ...
    def test_nxos_hostname_rendered(self):
        set_module_args(
            {"config": {"hostname": "NXOSv-9k"}, "state": "rendered"},
            ignore_provider_arg,
        )
        commands = ["hostname NXOSv-9k"]
        result = self.execute_module(changed=False)
