...
class TestNxosFcInterfacesModule(TestNxosModule):
    ...
    def test_parsed(self):
        ...
        set_module_args(
            dict(state="parsed", running_config=sh_run),
            ignore_provider_arg,
        )
        result = self.execute_module(changed=False)
    ...
    def test_analytics_none_to_scsi(self):
        ...
        self.assertEqual(
            result["commands"],
            ["interface fc1/1", "analytics type fc-scsi"],
        )
    ...
    def test_analytics_none_to_nvme(self):
        ...
        self.assertEqual(
            result["commands"],
            ["interface fc1/1", "analytics type fc-nvme"],
        )
    ...
    def test_analytics_none_to_all(self):
        ...
        self.assertEqual(
            result["commands"],
            ["interface fc1/1", "analytics type fc-all"],
        )
