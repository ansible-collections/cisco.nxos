...
- nxos_snmp_community - (deprecated, removed after 2024-01-01) Manages SNMP community configs.
- nxos_snmp_contact - (deprecated, removed after 2024-01-01) Manages SNMP contact info.
- nxos_snmp_host - (deprecated, removed after 2024-01-01) Manages SNMP host configuration.
- nxos_snmp_location - (deprecated, removed after 2024-01-01) Manages SNMP location information.
- nxos_snmp_traps - (deprecated, removed after 2024-01-01) Manages SNMP traps.
- nxos_snmp_user - (deprecated, removed after 2024-01-01) Manages SNMP users for monitoring.
...
- nxos_vsan - Configuration of vsan for Cisco NXOS MDS Switches.
...
- nxos_zone_zoneset - Configuration of zone/zoneset for Cisco NXOS MDS Switches.
